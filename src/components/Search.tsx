    ...
    const handleSearch = async (e: React.FormEvent) => {
     ...
     return (
        ...
        <div className="">
          ...
          <div className="min-w-100 w-full flex-row flex relative">
              <input className="w-full p-4 outline-none  border-b bg-white rounded-r-full " type="text" onChange={(e) => setQuery(e.target.value)} placeholder="Search.." required name="search"></input>
            <button className="cursor-pointer absolute right-0 p-4 bg-red-400 text-white transition hover:bg-red-600 rounded-full " onClick={handleSearch}><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="icon icon-tabler icons-tabler-outline icon-tabler-search"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M3 10a7 7 0 1 0 14 0a7 7 0 1 0 -14 0" /><path d="M21 21l-6 -6" /></svg></button>
          </div>
