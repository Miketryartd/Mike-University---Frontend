    ...
    <>
      <div className="min-h-screen bg-gray-100">
        <div>
          <img
            loading="lazy"
            className="p-5 h-25 w-50 object-cover rounded-md"
            src={logo_2}
          ></img>
        </div>
        ...
        <div className="mt-20 flex items-center justify-center bg-gray-100">
          <form
            className="flex flex-col gap-4 bg-white p-8 w-96 rounded-md shadow-md"
            method="POST"
            onSubmit={handleLogin}
          >
            <input
              className="border-b border-t-none border-slate-800/40 outline-none text-black p-3"
              type="email"
              placeholder="Email"
              name="email"
              required
            ...
            <p>
              ...
              <Link
                className="hover:underline text-red-400 transition hover:text-red-600"
                to="/Register"
              >
                Register here.
              </Link>
